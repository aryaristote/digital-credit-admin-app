...
let AnalyticsService = class AnalyticsService {
    ...
    async getDashboardStats() {
        const [totalUsers, activeUsers, newUsersThisMonth] = await Promise.all([
            ...
            this.userRepository.count({ where: { role: user_role_enum_1.UserRole.CUSTOMER, isActive: true } }),
            this.userRepository
        ...
        const [totalCreditRequests, pendingCredits, activeCredits, completedCredits,] = await Promise.all([
            ...
            this.creditRepository.count({ where: { status: credit_request_entity_1.CreditStatus.COMPLETED } }),
        ]);
